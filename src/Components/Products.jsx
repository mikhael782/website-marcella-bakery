...
const Products = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto py-16 px-4" style={{ fontFamily: '"Comic Sans MS", "Comic Neue", sans-serif' }}>
            <h2 className="text-xl font-bold text-pink-500 mt-8 mb-6 capitalize">
